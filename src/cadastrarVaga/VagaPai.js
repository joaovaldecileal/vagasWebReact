...
export default class VagaPai extends Component {
        ...
        return (
            <div><h3>LISTA DE VAGAS</h3>
                <ListarVaga
                    ...
                    onAdicionarCandidato = {(vaga) => this.adicionarCandidato(vaga)}
                     />
                <br></br>
